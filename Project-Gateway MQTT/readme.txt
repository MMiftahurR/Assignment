...
Untuk database pada project yang saya kerjakan tidak bersifat distributed. sehingga untuk sensor-to-cloud gateway hanya terhubung dengan database biasa, bukan distributed database.
