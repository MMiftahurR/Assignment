...
class loadBalancer(app_manager.RyuApp):
	...
	def __init__(self, *args, **kwargs):
		...
		self.serverlist.append({'ip': "10.0.0.1", 'mac': "66:98:2b:f0:2b:bc","outport": "1"})
		self.serverlist.append({'ip': "10.0.0.2", 'mac': "92:bc:b4:d7:fa:66", "outport": "2"})
		self.serverlist.append({'ip': "10.0.0.3", 'mac': "c2:51:8e:7c:ef:20", "outport": "3"})
		self.req = 0
